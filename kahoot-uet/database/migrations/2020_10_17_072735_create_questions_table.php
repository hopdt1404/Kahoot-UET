...
class CreateQuestionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('questions', function (Blueprint $table) {
            ...
            $table->unsignedInteger('time')->nullable(true)->default(0)->comment('Thời gian tối đa trả lời câu hỏi');
            $table->unsignedInteger('score')->nullable(true)->default(0)->comment('Số điểm tối đa đạt đươc của câu hỏi');
            ...
            $table->unsignedSmallInteger('number_correct_answer')->nullable(true);
            $table->longText('question_img')->nullable(true)->comment('Ảnh chính của câu hỏi');
            $table->timestamps();
        });
    }
