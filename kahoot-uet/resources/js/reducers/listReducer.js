    ...
    switch (type) {
        ...
        case "SET_QUESTION_CONTENT": {
            ...
            const newQuestion = {
                ...
                questionContent: payload.content
            };
        ...
        case "SET_CORRECT_ANSWER": {
            ...
            const newAnswers = [...newList[payload.orderNumber].answers];
            if (
                newList[payload.orderNumber].questionType == "True or False" &&
                newAnswers.filter(a => a.correct == true).length > 0
            ) {
                newAnswers.splice(
                    0,
                    2,
                    {
                        answer: newAnswers[0].answer,
                        correct: !newAnswers[0].correct
                    },
                    {
                        answer: newAnswers[1].answer,
                        correct: !newAnswers[1].correct
                    }
                );
            } else {
                newAnswers.splice(payload.aOrderNumber, 1, {
