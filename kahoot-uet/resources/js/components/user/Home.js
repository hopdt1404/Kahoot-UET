...
export default class Home extends React.Component{
    ...
    componentDidMount() {
        ...
        axios
            .get("http://127.0.0.1:8000/api/auth/home",config)
            .then(res => {
            ...
            return(
                <div class = "container mt-2 mb-2">
                    <Link class= "d-flex flex-row home-kahootlist-quest" to={this.route(data.id)}>
                        <img class="home-kahootlist-image" src={data.image} style={{backgroundImage:'url('+my_kahoot+')'}}>
                        </img>
            ...
            <div>
                ...
                <div class="home-main-content container d-flex pt-5 justify-content-center">
                    ...
                    <div class="col-sm-4 home-kahoot-list">
                        ...
                        {this.state.kahootlist.splice(0, 3).map(each => <KahootList data={each} />)}
